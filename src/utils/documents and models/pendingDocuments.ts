...
const invalidStandard: InvalidDocuments = {
  ...
  "cr/n":
    "Comprovante de residência emitido nos últimos 60 dias + Declaração de Residência (Anexo II no link abaixo) caso o comprovante esteja no nome de terceiros",
  "cr/dsc":
  ...
  "id/n":
    "Documento de Identidade (RG ou CNH ou Conselho de Classe)",
...
Solteira - Certidão de nascimento`,
  ...
  "un/nd":
    "Declaração de união estável + Certidão de acordo com estado civil anterior à união estável (caso fora casado/divorciado/separado, enviar certidão de casamento; caso fora solteiro, enviar certidão de nascimento)",

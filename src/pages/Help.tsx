  ...
  return (
    <>
      <Content className=" py-4">
        ...
        <Text>
          Aplicativo feito para verificar o cadastro com base no que <strong>falta</strong>, gerando uma mensagem automática de recusa.
        </Text>
        ...
        <br />
        <Text>
          Cada caixinha foi pensada para gerar <b>apenas uma</b> pequena mensagem cada, que é junta com as partes superiores e inferiores da mensagem.
        </Text>
        <br />
        <br />
        <Text>
